...
const WIKI_TYPES = {
  ...
  Goal:      { bg: "var(--wiki-type-goal-bg)",      text: "var(--wiki-type-goal-text)",      border: "var(--wiki-type-goal-border)" },
  Project:   { bg: "var(--wiki-type-project-bg)",   text: "var(--wiki-type-project-text)",   border: "var(--wiki-type-project-border)" },
  Principle: { bg: "var(--wiki-type-principle-bg)", text: "var(--wiki-type-principle-text)", border: "var(--wiki-type-principle-border)" },
